            ...
            <div>
              ...
              <Body>
                      ...
                      <FormattedMessage {...messages.nextPageLabel} >
                        {
                          (formattedMSG) => (
                            <ContactForm
                              locale={this.props.locale}
                              onSubmit={ () => updateCurrentSection(PROFILE_SECTIONS.account)}
                              submitButtonTitle={formattedMSG}
                            />
                          )
                        }
                      ...
                      <FormattedMessage {...messages.nextPageLabel} >
                        {
                          (formattedMSG) => (
                            <AboutMeForm
                              locale={this.props.locale}
                              onSubmit={ () => updateCurrentSection(PROFILE_SECTIONS.contact_info)}
                              submitButtonTitle={formattedMSG}
                            />
                          )
                        }
                ...
                <Badge
                  badgeContent={27}
                  secondary={true}
                  badgeStyle={{top: 16, right: 16, zIndex: '100'}}

...
function FacebookIcon(props) {
  ...
  if (!style) {
    style = { enableBackground: 'new 0 0 430.113 430.114' };
  } else {
    style.enableBackground = 'new 0 0 430.113 430.114';
  }

  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" width={width} height={height} viewBox="0 0 430.113 430.114" style={style} >

...
function SVGConstructionCone(props) {
  const {
    className,
    color = null,
    width = 64, height = 64,
    style = { enableBackground: 'new 0 0 504.124 504.124' }
  } = props;

  return (
    <svg className={className} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="ttp://www.w3.org/1999/xlink" viewBox="0 0 504.124 504.124" width={width} height={height} xmlSpace="preserve" style={style} >
      <title id="title">Cone Icon</title>
...
export default SVGConstructionCone;

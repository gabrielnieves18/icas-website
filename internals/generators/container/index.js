...
module.exports = {
  ...
  actions: (data) => {
    // Generate LanguageSectionForm.js and index.tests.js
    const actions = [{
      type: 'add',
      path: '../../app/containers/{{properCase name}}/LanguageSectionForm.js',
      templateFile: './container/LanguageSectionForm.js.hbs',
      abortOnFail: true,
    }, {
      type: 'add',
